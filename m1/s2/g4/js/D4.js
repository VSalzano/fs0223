...
for(let i = 0; i < starWarsCharacters.length; i++) {
  if(starWarsCharacters[i].gender == "female"){
    const femChar = {}
    femChar ['name'] = starWarsCharacters[i].name;
    femChar ['hair_color'] = starWarsCharacters[i].hair_color;
    femChar ['eye_color'] = starWarsCharacters[i].eye_color;

    femaleCharacters.push(femChar);
  }
}
